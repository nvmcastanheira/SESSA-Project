...
ps = subprocess.Popen("/home/nuno/Desktop/fun/Sessa-2.2.0-Linux/bin/sessa -c", shell=True,
...
#loop over params
    for par in tqdm.tqdm(params, desc = "Parameters: /{}/{}".format(mat[0],mat[1])):
        ...
        path = "/home/nuno/Desktop/fun/output/{}{}_Thickness_{}".format(mat[0],mat[1][0:2],par)
        os.mkdir(path)
